...
func (c *SidecarCollector) initDescs() {
	...
	c.counter("sidecar_prioritized_tx_committed_before_echo_total", "Prioritized TXs committed before echo Insert arrived")
	c.counter("sidecar_prioritized_tx_dropped_before_echo_total", "Prioritized TXs dropped before echo Insert arrived")
	c.counter("sidecar_prioritized_tx_evicted_before_echo_total", "Prioritized TXs evicted before echo Insert arrived")
...
func (c *SidecarCollector) Collect(ch chan<- prometheus.Metric) {
	...
	emitCounter("sidecar_prioritized_tx_committed_before_echo_total", m.PrioritizedTxCommittedBeforeEcho.Load())
	emitCounter("sidecar_prioritized_tx_dropped_before_echo_total", m.PrioritizedTxDroppedBeforeEcho.Load())
	emitCounter("sidecar_prioritized_tx_evicted_before_echo_total", m.PrioritizedTxEvictedBeforeEcho.Load())
