...
func TestSidecarCollector_RegistersAndCollects(t *testing.T) {
	...
	m.PrioritizedTxCommittedBeforeEcho.Store(5)
	m.PrioritizedTxDroppedBeforeEcho.Store(3)
	m.PrioritizedTxEvictedBeforeEcho.Store(1)
	...
	expectMetric(t, output, "sidecar_prioritized_tx_committed_before_echo_total", "5")
	expectMetric(t, output, "sidecar_prioritized_tx_dropped_before_echo_total", "3")
	expectMetric(t, output, "sidecar_prioritized_tx_evicted_before_echo_total", "1")
